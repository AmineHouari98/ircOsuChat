...
myParentObject::myParentObject()
{
    ...
    EnumColumnMessages();
    addToMap(EnumTableMessages::tableName, EnumTableMessages::columnsList) ;
...
QStringList myParentObject::getColumnFromTable(QString tableName,  QString columnName)
{
    ...
    qDebug() << "getColumnFromTable " << temperare  << query;
    return temperare ;
}
QStringList myParentObject::getColumnFromTable(QString tableName,  QString columnName,QString filter)
{
    QStringList temperare ;
    QString query ;
    query = "select "+columnName+" from "+ tableName +" where "+filter+" ;" ;
    QSqlQuery cmd(query) ;
    ...
    qDebug() << "getColumnFromTables " << temperare  << query;
    return temperare ;
}
//QStringList myParentObject::getRowFromTable(QString tableName,  QString columns,QString filter)
//{
//    QStringList temperare ;
//    QString query ;
//    query = "select "+columns+" from "+ tableName +" where "+filter+" ;" ;
//    QSqlQuery cmd(query) ;
